// Probe the reference site: dump geometry + computed styles of selectors.
// Usage: node scripts/parity/probe.mjs <url> <scrollY> <sel1> <sel2> ...
...
const out = await page.evaluate((sels) => {
  ...
  for (const sel of sels) {
    ...
    res[sel] = nodes.slice(0, 3).map((el) => {
